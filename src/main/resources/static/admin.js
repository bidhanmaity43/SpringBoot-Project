...
const createNewPostOption = document.querySelector('.option-block:nth-child(1)');
createNewPostOption.addEventListener('click', () => {
    window.location.href = 'create-post.html';
});

// Redirect to update-post.html when clicking on "Update Post" option
const updatePostOption = document.querySelector('.option-block:nth-child(2)');
updatePostOption.addEventListener('click', () => {
    window.location.href = 'update-post.html';
});

// Redirect to createUser.html when clicking on "Create User" option
const createUser = document.querySelector('.option-block:nth-child(3)');
createUser.addEventListener('click', () => {
    window.location.href = 'createUser.html';
});

// Redirect to view-post.html when clicking on "View Post" option
const viewPostOption = document.querySelector('.option-block:nth-child(4)');
